          ...
          {countryData && countryData.map(data => {
            return (
              <StyledTableRow key={data.coordinates.latitude}>
                ...
                <StyledTableCell align="right" style={{backgroundColor: data.stats.confirmed > 10000 ? "rgba(255, 0, 0, 0.6)" : "" }}>{data.stats.confirmed}</StyledTableCell>
                <StyledTableCell align="right">
                  {data.stats.recovered}
                </StyledTableCell>
                <StyledTableCell align="right">{data.stats.deaths}</StyledTableCell>
                <StyledTableCell align="right">{data.updatedAt}</StyledTableCell>
              </StyledTableRow>
            );
          })}
        </TableBody>
